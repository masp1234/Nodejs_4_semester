...
console.log(process.argv.find(argument => argument === 'delete_mode'));
const deleteModeArgument = process.argv.findIndex(argument => argument === 'delete_mode') === -1 ? false : true;

const isDeleteMode = deleteModeArgument
